      ...
      <div style={{ margin: "16px 16px 0", flex: 1, display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        {activeNav === "profile" && (
          <div style={{ background: t.CARD, borderRadius: 16, border: `1px solid ${t.CARD_BORDER}`, boxShadow: isDark ? "0 4px 32px rgba(0,0,0,0.3)" : "0 2px 16px rgba(0,0,0,0.07)", overflow: "hidden" }}>
            <div style={{ padding: "18px 20px 6px", borderBottom: `1px solid ${t.CARD_BORDER}`, display: "flex", alignItems: "center", gap: 8 }}>
              <Settings style={{ width: 16, height: 16, color: t.PP_BLUE }} />
              <span style={{ fontSize: 14, fontWeight: 700, color: t.TEXT }}>Profile &amp; Settings</span>
            </div>
            <div style={{ padding: "20px" }}>

              {/* Wallet info */}
              <div style={{ marginBottom: 20, padding: "12px 14px", background: t.INPUT_BG, borderRadius: 10, border: `1px solid ${t.INPUT_BORDER}` }}>
